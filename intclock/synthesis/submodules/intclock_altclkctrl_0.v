...
module  intclock_altclkctrl_0_sub
	( 
	ena,
	inclk,
...
`endif
	...
	assign
		...
		inclk_wire = {inclk},
		outclk = wire_clkctrl1_outclk;
endmodule //intclock_altclkctrl_0_sub
...
module  intclock_altclkctrl_0  (
    ...
    intclock_altclkctrl_0_sub  intclock_altclkctrl_0_sub_component (
                .ena (sub_wire1),
                .inclk (sub_wire3),
                .outclk (sub_wire0));
